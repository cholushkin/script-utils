...
PromptContextCollector(
    ...
    template_path="ScriptUtils/UserScriptsExamples/AnalyzeScriptsPromptTemplate.txt",  # Relative to project root
    template_vars={"additional_task_0": "Share ideas to expand the concept and introduce innovative or interesting new features."},
    output_path="ScriptUtils/UserScriptsExamples/OutputPrompts/PromptContextCollectorScriptAnalysis.txt"
).run()